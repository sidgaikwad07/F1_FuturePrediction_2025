"""
Created on Sun May 18 10:30:39 2025

@author: sid
Clean & Normalize 2024 F1 Season Data
...
def clean_2024_data():
    ...
    for folder_name in tqdm(os.listdir(RAW_DATA_PATH), desc="🧹 Cleaning 2024"):

"""
Created on Tue May 20 09:15:37 2025
@author: sid

FP-Friendly Cleaner for 2023 F1 Season
...
SAVE_PATH = "/Users/sid/Downloads/F1_FuturePrediction_2025/clean_data/2023_cleaned.csv"
...
def clean_2023_data_fp_friendly():
    all_laps = []
    YEAR = 2023

    for folder_name in tqdm(os.listdir(RAW_DATA_PATH), desc="🧼 FP-Friendly Clean 2023"):
        if not folder_name.startswith("2023_"):
            continue
        ...
        gp_name = folder_name.split("2023_", 1)[-1].rsplit("_", 1)[0]

"""
Created on Sun May 18 09:50:37 2025

@author: sid
Clean & Normalize 2023 F1 Season Data
...
def clean_2023_data():
    ...
    for folder_name in tqdm(os.listdir(RAW_DATA_PATH), desc="🧹 Cleaning 2023"):

"""
Created on Sun May 19 23:32:52 2025
@author: sid

FP-Friendly Cleaner for 2022 F1 Season
...
SAVE_PATH = "/Users/sid/Downloads/F1_FuturePrediction_2025/clean_data/2022_cleaned.csv"
...
def clean_2022_data_fp_friendly():
    all_laps = []
    YEAR = 2022

    for folder_name in tqdm(os.listdir(RAW_DATA_PATH), desc="🧼 FP-Friendly Clean 2022"):
        if not folder_name.startswith("2022_"):
            continue
        ...
        gp_name = folder_name.split("2022_", 1)[-1].rsplit("_", 1)[0]
